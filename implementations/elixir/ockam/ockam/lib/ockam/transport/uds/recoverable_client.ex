defmodule Ockam.Transport.UDS.RecoverableClient do
  @moduledoc """
  UDS client wrapper to recover connections.

  Creates and monitors Ockam.Transport.UDS.CLient
  ...
  @impl true
  def address_prefix(_options), do: "UDS_C_R_"
